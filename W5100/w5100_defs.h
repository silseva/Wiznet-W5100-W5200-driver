...
const unsigned char MAX_SOCK_NUM  = 4;

const unsigned int COMMON_BASE = 0x0000;

const unsigned int TX_BUF_BASE = COMMON_BASE + 0x4000;  //TX buffer memory base address

const unsigned int RX_BUF_BASE = COMMON_BASE + 0x6000;  //RX buffer memory base address
...
const unsigned int RMSR            = COMMON_BASE + 0x001A;  //sockets RX memory size register
const unsigned int TMSR            = COMMON_BASE + 0x001B;  //sockets TX memory size register

const unsigned int UIPR0           = COMMON_BASE + 0x002A;  //unreacheable IP address register base address
const unsigned int UPORT0          = COMMON_BASE + 0x002E;  //unreacheable port register base address
...
const unsigned char MR_AI           = 0x02; //I/F bus auto increment, refer to datasheet
const unsigned char MR_IND          = 0x01; //indirect I/F bus auto increment, refer to datasheet

/* IR register values */
const unsigned char IR_CONFLICT     = 0x80; //IP conflict
const unsigned char IR_UNREACH      = 0x40; //destination host unreachable
...
const unsigned int SR_BASE         = COMMON_BASE + 0x0400;  //socket registers base address
