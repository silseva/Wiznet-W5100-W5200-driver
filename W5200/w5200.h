...
public:
     ...
     */
    uint8 readSocketInterruptReg();
    
    /**
     * Configures chip's IMR2 register, please refer to datasheet
     */    
    void setSocketInterruptMask(uint8 mask);
     ...
     */
    void setSocketInterruptMaskReg(SOCKET sockNum, uint8 value);
     ...
     */
    void setSocketFragmentValue(SOCKET sockNum, uint16 value);
